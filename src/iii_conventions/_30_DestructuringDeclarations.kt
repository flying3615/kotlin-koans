...
private operator fun  MyDate.component1() = this.year
private operator fun  MyDate.component2() = this.month
private operator fun  MyDate.component3() = this.dayOfMonth
